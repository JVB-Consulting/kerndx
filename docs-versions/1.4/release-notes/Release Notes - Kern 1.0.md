...
> This document is the **comprehensive v1.0 feature reference** — every shipping module, what it does, and the subscriber-visible surface. For chronological per-version changes (what's new since the last build), see the CHANGELOG.
