...
**Release status:** in development. The 1.3 feature set is complete; the package build and end-to-end testing are in progress. The package version id and release tag will be published with the release.
