...
| **No public community yet**                                     | You cannot search Stack Overflow for KernDX errors yet. Offset by 37 developer documents (21 guides, 16 fast starts), 268 API references, and the AI context files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **Documentation**                  | 37 developer documents (21 guides, 16 fast starts) and 268 API references, all published as a searchable documentation site                                                                                                                                                                                                                              | Per-library documentation sites                                                                                                                                                                   |
...
| **LWC**                 | 63      | Component library with five built-in modules and registry-dispatch activation (only Apex framework surveyed that ships a base component with the common LWC wiring already built in for you to extend)                                                                                                                                                      | `ComponentBuilder`                                                     |
...
| Metric                     | Value                                                                                                                                                                                                                                                                                                         |
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Apex classes               | [363 (189 production, 174 test)](Strategic%20Guide%20-%20Metrics.md#package-codebase)                                                                                                                                                                                                                                                                                |
| Selector classes           | 44 (most extend `SEL_Base`)                                                                                                                                                                                                                                                                                     |
| Flow invocable classes     | 16 (`FLOW_*`)                                                                                                                                                                                                                                                                                                 |
| Test methods               | ~6,400 (~3,700 Apex + ~2,660 Jest)                                                                                                                                                                                                                                                                            |
| Test coverage              | 100% per-file Apex, 95% statement/branch LWC (enforced at every release build)                                                                                                                                                                                                                                |
| Lines of code              | ~205K (~81K production Apex, ~79K Apex tests, ~13K LWC, ~31K Jest)                                                                                                                                                                                                                                            |
| LWC components             | 63                                                                                                                                                                                                                                                                                                            |
| Custom objects             | 10                                                                                                                                                                                                                                                                                                            |
...
| Documentation              | 37 developer documents (21 guides, 16 fast starts), 268 API reference pages                                                                                                                                                                                                                                   |
...
| **Reference**      | 268 API References                                                                                                                       | Auto-generated ApexDoc for every class, method, property                                               |
...
| Discoverable architecture    | 37 developer documents (21 guides, 16 fast starts), 268 API references; `AGENTS.md` + `docs/Code Conventions - Guide.md` (repo root) + [`AI Agent Instructions`](AI%20Agent%20Instructions.md) (framework reference) for AI-assisted development |
...
| **Design Authority**    | [63 LWC components](Strategic%20Guide%20-%20Metrics.md#lwc-components), `ComponentBuilder` pattern                                  | UI/UX design, accessibility audits, user research                          |
...
| **Documentation**       | 37 developer documents (21 guides, 16 fast starts), 268 API references, `AGENTS.md` + `docs/Code Conventions - Guide.md` (repo-root AI instructions) + [AI Agent Instructions](AI%20Agent%20Instructions.md) (per-module framework reference) | Public README, docs, contribution guide, met                                                                                                                                                          |
...
| Test depth                 | [174 test classes vs 189 production classes](Strategic%20Guide%20-%20Metrics.md#package-codebase) (~92% test-to-production ratio); per-file 100% Apex coverage gate + 95% statement/branch LWC, enforced at every release build; subscriber-realism e2e harness (471 anonymous-Apex assertions across 71 sections plus 175 `@IsTest` methods across 39 subscriber test classes); extended load testing suite; rolling perf-history baselines; drift audit cycle | KernDX is the only Apex framework surveyed with a coverage gate enforced at every build.                                                                                               |
...
| Threat model documentation | Bespoke [2,326-line Security Guide](Strategic%20Guide%20-%20Metrics.md#documentation)                                                                                                                                                                                                                                                                                                                                                                        | 11 of 21 comparators ship no `SECURITY.md` at all; 4 ship the same templated `SECURITY.md`.                                                                                            |
...
| **KernDX**               | BSL 1.1 licensed, 2+ years development. Published publicly on GitHub with the full developer documentation set (37 developer documents, 268 API references), public CI (`ci.yml`), issue templates, `CONTRIBUTING.md`, and a Code of Conduct. Converts to Apache 2.0 four years after release.                 |
...
2. **Layered documentation.** 37 developer documents (21 guides, 16 fast starts) and 268 API references.
