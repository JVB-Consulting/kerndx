...
| Method | Description |
|--------|-------------|
| global abstract [List](https://developer.salesforce.com/docs/atlas.en-us.apexref.meta/apexref/apex_methods_system_list.htm) [getParameterDefinitions](#getparameterdefinitions)() | Returns the parameter definitions supported by this scheduled class. |
