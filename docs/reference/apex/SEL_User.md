...
| global virtual override [List](https://developer.salesforce.com/docs/atlas.en-us.apexref.meta/apexref/apex_methods_system_list.htm) [getFieldPaths](#getfieldpaths)() | Returns relationship field paths for User queries. |
| global virtual override [List](https://developer.salesforce.com/docs/atlas.en-us.apexref.meta/apexref/apex_methods_system_list.htm) [getFields](#getfields)() | Returns the core SObjectField tokens for User queries. |
