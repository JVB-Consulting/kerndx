...
- [ ] **API version 66.0** — org and project metadata aligned to API 66.0
...
**Data Layer Path**
> [Selectors](Fast%20Start%20-%20Selectors.md) → [DML](Fast%20Start%20-%20DML.md) → [Test Data](Fast%20Start%20-%20Test%20Data.md)
...
**Integration Path**
> [Outbound APIs](Fast%20Start%20-%20Outbound%20APIs.md) → [Inbound APIs](Fast%20Start%20-%20Inbound%20APIs.md) → [Async Chains](Fast%20Start%20-%20Async%20Processing.md) → [Feature Flags](Fast%20Start%20-%20Feature%20Flags.md) → [Logging](Fast%20Start%20-%20Logging.md)
...
| Name | Description | Key Classes |
|------|-------------|-------------|
| [Code Scanning](Fast%20Start%20-%20Code%20Scanning.md) | PMD and ESLint enforcement of framework conventions in IDE and CI/CD | — |

### Testing

| Name | Description | Key Classes |
|------|-------------|-------------|
| [E2E Testing](Fast%20Start%20-%20E2E%20Testing.md) | Browser-based Playwright tests for Salesforce Lightning | — |
...
| [Security - Guide](Security%20-%20Guide.md) | CRUD/FLS enforcement, sharing control, encryption, password breach detection |
