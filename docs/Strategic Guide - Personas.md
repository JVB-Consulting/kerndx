...
| [End-to-end subscriber harness](Strategic%20Guide%20-%20Metrics.md#release-testing) | 471 anonymous-Apex assertions across 71 sections, plus 175 test methods across 39 subscriber test classes |
...
| Package size               | [363 classes (189 production, 174 test)](Strategic%20Guide%20-%20Metrics.md#package-codebase): the footprint of an integrated stack                                                                                                                                                                                                                          | SOQL Lib: ~15 classes. Apex Fluently: 8 libraries you install independently                                                              |
...
| Test coverage              | 100% per-file Apex enforced at every release build; [3,742 `@IsTest` methods across 174 test classes](Strategic%20Guide%20-%20Metrics.md#package-codebase); end-to-end subscriber harness                                                                                                                                                           | Varies by framework                                                                                                                      |
