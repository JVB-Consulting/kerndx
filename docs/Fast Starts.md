...
| Fast Start | What you get working |
|---|---|
...
| [Outbound APIs](./Fast%20Start%20-%20Outbound%20APIs.md) | Resilient callouts — retry, circuit breaker, idempotency body-hash, and a dead-letter queue. |
